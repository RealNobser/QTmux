...
**1.5.1** mit Early-Adopter-Installern für **macOS, Windows und Linux**. Siehe [Roadmap](#roadmap).
...
|---|---|---|
| macOS | [`installer/build-dmg.sh`](installer/build-dmg.sh) `1.5.1` | `dist/QTmux-1.5.1-macos.dmg` |
| Windows | [`installer\build-msi.ps1`](installer/build-msi.ps1) `-Version 1.5.1` | `dist\QTmux-1.5.1-win64.msi` (+ portables ZIP) |
| Linux | [`installer/build-appimage.sh`](installer/build-appimage.sh) `1.5.1` | `dist/QTmux-1.5.1-x86_64.AppImage` |
...
**1.5.1** with early-adopter installers for **macOS, Windows and Linux**. See the [Roadmap](#roadmap-1).
...
|---|---|---|
| macOS | [`installer/build-dmg.sh`](installer/build-dmg.sh) `1.5.1` | `dist/QTmux-1.5.1-macos.dmg` |
| Windows | [`installer\build-msi.ps1`](installer/build-msi.ps1) `-Version 1.5.1` | `dist\QTmux-1.5.1-win64.msi` (+ portable ZIP) |
| Linux | [`installer/build-appimage.sh`](installer/build-appimage.sh) `1.5.1` | `dist/QTmux-1.5.1-x86_64.AppImage` |
